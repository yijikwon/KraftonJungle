...
│   └── 02_advanced/          # 심화 문제 (난이도 오름차순, 자체 지문 + 자체 테스트)
...
> | 폴더 | 문제 수 | 번호 범위 | 비고 |
> |---|---|---|---|
> | `week2/01_basic` | 15 | 01 ~ 15 | 문자열/배열/딕셔너리부터 자료구조까지 |
> | `week2/02_advanced` | 5 | 01 ~ 05 | 분할정복·재귀·백트래킹 응용 |
> | `week3/01_basic` | 9 | 01 ~ 09 | 트리/그래프/DP/그리디 입문 |
> | `week3/02_advanced` | 3 | 01 ~ 03 | 그래프 응용 + 고급 DP |
